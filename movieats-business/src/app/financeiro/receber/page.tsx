...
export default function ReceberPage() {
  ...
  const transacoes: Transacao[] = [
    { id: "1", origem: "VENDA #4590", valor: 156.90, data: "2026-04-11", status: "RECEBIDO", metodo: "PIX" },
    { id: "2", origem: "VENDA #4591", valor: 89.50, data: "2026-04-11", status: "PENDENTE", metodo: "CARTÃO" },
    { id: "3", origem: "RECARGA IFood", valor: 450.00, data: "2026-04-15", status: "PENDENTE", metodo: "TRANSFERÊNCIA" },
  ];
      ...
      <div className="max-w-[1400px] mx-auto space-y-5 pb-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-5 bg-white dark:bg-zinc-900 p-5 rounded-md border border-slate-200 dark:border-zinc-800 shadow-sm transition-all duration-300">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-headline font-black text-slate-900 dark:text-white uppercase tracking-tight">A Receber</h2>
              <p className="text-[9px] font-black text-slate-400 dark:text-zinc-700 tracking-[0.2em] uppercase mt-1">Gestão de Entradas e Recebíveis</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-zinc-900 p-5 rounded-md border border-slate-200 dark:border-zinc-800 shadow-sm">
             <span className="text-[9px] font-black text-slate-400 dark:text-zinc-700 tracking-[0.2em] uppercase">Total Receber</span>
             <h3 className="text-2xl font-black text-slate-900 dark:text-white mt-2">R$ 539,50</h3>
          </div>
          <div className="bg-white dark:bg-zinc-900 p-5 rounded-md border border-slate-200 dark:border-zinc-800 shadow-sm">
             <span className="text-[9px] font-black text-slate-400 dark:text-zinc-700 tracking-[0.2em] uppercase">Hoje</span>
             <h3 className="text-2xl font-black text-emerald-500 mt-2">R$ 156,90</h3>
          </div>
          <div className="bg-white dark:bg-zinc-900 p-5 rounded-md border border-slate-200 dark:border-zinc-800 shadow-sm">
             <span className="text-[9px] font-black text-slate-400 dark:text-zinc-700 tracking-[0.2em] uppercase">Atrasados</span>
             <h3 className="text-2xl font-black text-red-500 mt-2">R$ 0,00</h3>
          </div>
        </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-slate-100 dark:border-zinc-800 bg-slate-50/50 dark:bg-zinc-800/20">
                  <th className="px-6 py-4 text-[9px] font-black text-slate-500 uppercase tracking-widest">Origem / Método</th>
                  ...
                  <tr key={item.id} className="group hover:bg-slate-50/50 dark:hover:bg-zinc-800/20 transition-all">
                    <td className="px-6 py-4">
                      <div className="flex flex-col">
                        <span className="text-xs font-black text-slate-900 dark:text-white uppercase tracking-tight">{item.origem}</span>
                        <span className="text-[9px] text-slate-500 dark:text-zinc-600 font-bold uppercase mt-0.5">{item.metodo}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4">
