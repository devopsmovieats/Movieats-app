          ...
          <div className="glass border border-white/5 rounded-xl flex flex-col h-full overflow-hidden shadow-2xl relative">
            ...
            <div className="p-4 bg-white/[0.01] border-t border-white/5 space-y-4">
              ...
              <div className="pt-4 border-t border-white/5 space-y-3">
                  ...
                  <button className="w-full bg-primary hover:bg-orange-600 text-white py-3 rounded-lg font-black text-[10px] uppercase tracking-[0.2em] shadow-xl shadow-primary/10 transition-all active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer" disabled={cart.length === 0 || !paymentMethod}>
                    Finalizar Pedido
                  </button>
              </div>
            </div>
